...
Usage:
    python -m scholar.core.ml.evaluate_ml --trials 20 --configs D-M D-U M-M M-U
"""
...
import scholar.core.planner as _planner_mod
from scholar.core.planner import run_online_surp_push
from scholar.core.scene_configs import generate_config_environment
from scholar.core.constants import SCENE_CONFIGS
from scholar.core.ml.push_policy import PushAvoidPolicy, COLLECT
...
def main():
    ...
    import scholar.core.ml.push_policy as pp_mod
