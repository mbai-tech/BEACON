...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Bug1 planning trials.")
    ...
    episodes = run_trials(n_trials=args.trials, planner_name="bug")
    print_summary(aggregate(episodes), planner_name="bug")
