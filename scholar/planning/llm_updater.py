"""LLMWeightUpdater — queries Qwen to propose PlannerConfig updates from SceneSummary diagnostics."""
...
class LLMWeightUpdater:
    ...
    def update(
        ...
        w_v_range are applied from the LLM proposal; all other parameters revert
