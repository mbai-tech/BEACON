...
After running enough simulations with COLLECT=True in push_policy.py:
    ...
    python -m scholar.ml.train_push_policy

The trained model is saved to scholar/ml/push_policy_model.pkl and will
...
from scholar.ml.push_policy import LOG_PATH, MODEL_PATH, extract_features
