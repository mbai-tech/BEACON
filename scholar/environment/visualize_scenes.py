"""
visualize_scenes.py — Render all scenes to PNG and show how to load them.

Usage
-----
    python scholar/environment/visualize_scenes.py               # all legacy scenes, mixed
    python scholar/environment/visualize_scenes.py --fragility uniform
    python scholar/environment/visualize_scenes.py --index 0 5 12
    python scholar/environment/visualize_scenes.py --family dense_clutter
    python scholar/environment/visualize_scenes.py --family narrow_passage --index 0 1 2
"""
