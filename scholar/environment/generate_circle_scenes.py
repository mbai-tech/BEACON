...
Usage
-----
    python scholar/environment/generate_circle_scenes.py
    python scholar/environment/generate_circle_scenes.py --family dense_clutter
    python scholar/environment/generate_circle_scenes.py --n 100 --fragility mixed
"""
